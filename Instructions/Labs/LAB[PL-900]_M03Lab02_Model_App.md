...
9. Klik **Simpan** dan tunggu hingga perubahan disimpan.
...
5. Pada layar Tambahkan Halaman, pilih **Tabel Dataverse**, lalu pilih tombol **Berikutnya**.
...
11. Di Panel Navigasi, di grup keamanan, pilih **SubArea1**. 

12. Pilih **Ellipsis**, dan dari menu yang muncul, pilih **Hapus dari navigasi**. 

13. Klik **Simpan** dan tunggu hingga perubahan disimpan. 

14. Setelah **Simpan** selesai, pilih tombol **Terbitkan** untuk menerbitkan perubahan Anda. 


### <a name="task-2-test-app"></a>Tugas #2: Uji aplikasi
